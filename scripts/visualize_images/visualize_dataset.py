...
if __name__ == "__main__":
    args = arguments()
    print("FIFTYONE_DATABASE_URI:", os.environ.get("FIFTYONE_DATABASE_URI"))
...
Formato COCO:
python visualize_dataset.py --path SDC_dataset --format "coco"

Formato YOLO:
python visualize_dataset.py --path /home/herex/Escritorio/MASTER/Vision_por_computador/Trabajo_final/SDC_dataset/ --format yolo --split train
