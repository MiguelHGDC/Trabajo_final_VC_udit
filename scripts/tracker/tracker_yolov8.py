...
def process_video(video_path,
    ...
    :param output_path: Ruta del video de salida con las predicciones.
...
def main():
    ...
    video_path = '/home/herex/Escritorio/MASTER/Vision_por_computador/Trabajo_final/Entrega_tracker/video_trabajo_final/LA.mp4'
    # Ruta del video de salida
    tracker_yaml = '/home/herex/Escritorio/MASTER/Vision_por_computador/Trabajo_final/Trabajo_final_VC_udit/scripts/tracker/bytetrack.yaml'
    ...
    process_video(
                    video_path, 
                    model,
                    conf=0.1, # Editado mejor resultado
                    iou=0.3, # Editado mejor resultado
                    # conf=0.3, Por defecto
                    # iou=0.5, Por defecto
                    imgsz=640,
                    half=False,
                    device='cuda',
